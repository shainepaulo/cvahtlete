...
/**
 * Données de Noa Muller — source unique de vérité.
...
export const noaProfile: NoaProfile = {
  ...
  cinematic: {
    ...
    gallery: [
      ...
      { src: '/images/noa-cdm-u20.jpeg', alt: 'Noa de dos, maillot MULLER 1, stade FIFA U-20 World Cup', position: '65% 30%' },
    ],
    socials: [
  ...
  complet: {
    ...
    pdfUrl: '/docs/Noa_Muller_GK_2026.pdf',
